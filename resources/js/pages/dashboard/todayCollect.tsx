...
import { bikeCollect } from '@/types/dashboard/types';

type propsData = {
    data: bikeCollect[];
};

const columns: ColumnDef<bikeCollect>[] = [
    {
        accessorKey: 'bike_no',
        header: ({ column }) => {
            return (
...
export function TodayCollectBikes(props: propsData) {
    ...
    return (
        <div className="mt-4 mr-3 ml-3 rounded-lg border-1 border-gray-200 p-4">
            <Label className="ml-4 text-xl" htmlFor="email">
                Bikes to collect today
            </Label>
